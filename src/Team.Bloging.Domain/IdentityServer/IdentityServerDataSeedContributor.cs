...
namespace Team.Blogging.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateClientsAsync()
        {
            ...
            {
                var webClientRootUrl = configurationSection["Bloging_Web:RootUrl"].EnsureEndsWith('/');

                /* Bloging_Web client is only needed if you created a tiered
            ...
            //Console Test Client
            var consoleClientId = configurationSection["Bloging_ConsoleTestApp:ClientId"];
