...
namespace Team.Bloging
{
    ...
    public static class WebContentDirectoryFinder
    {
        public static string CalculateContentRootFolder()
        {
            ...
            while (!DirectoryContains(directoryInfo.FullName, "Team.Bloging.sln"))
            {
            ...
            var webFolder = Path.Combine(directoryInfo.FullName, $"src{Path.DirectorySeparatorChar}Team.Bloging.Web");
